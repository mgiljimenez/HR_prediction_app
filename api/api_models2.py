...
def retrain():
    try:
        ...
        # Cargamos el modelo y escalamos
        scaler = importar_scaler()
        ...
        # try:
        #     with open("C:/Users/mgilj/GitHub/HR_prediction_app/api/esta.pkl", 'wb') as archivo:
        ...
        try:
            conn = get_connection()
            cursor = conn.cursor()
                # Guardar los objetos en la tabla
            cursor.execute("INSERT INTO modelos (nombre, scaler) VALUES (%s, %s)", ("modelo_borrar", model))
