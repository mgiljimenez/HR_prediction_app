...
def new_prediction():
    try:
        ...
        try:
            # model = load_object("api/JP_12_06_VotingRegressor.pickle")
            model=np.load("JP_12_06_VotingRegressor.pickle",allow_pickle=True)
        ...
        try:
            #  scaler = load_object("api/scaler.pickle")
